...
_frontend_dir = os.path.join(os.path.dirname(_base_dir), 'frontend')
_template_folder = os.path.join(_frontend_dir, 'templates') if os.path.isdir(os.path.join(_frontend_dir, 'templates')) else os.path.join(_base_dir, 'templates')
_static_folder = os.path.join(_frontend_dir, 'static') if os.path.isdir(os.path.join(_frontend_dir, 'static')) else os.path.join(_base_dir, 'static')
